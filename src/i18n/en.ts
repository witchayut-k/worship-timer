export const en = {
  ...
  settings: {
    ...
    sectionSchedule: 'Program schedule',
    showPlannedTimes: 'Planned clock times',
    showPlannedTimesDesc: 'Start and end times on the timeline (requires event date and start time).',
    showTimelineRail: 'Timeline rail',
    showTimelineRailDesc: 'Vertical line and dots linking segments when a planned schedule is available.',
    showRowTimes: 'Row times',
    showRowTimesDesc: 'Countdown on the live segment and durations on upcoming rows.',
    timelineRequiresEvent: 'Set event date and planned start time in Program Setup to use timeline options.',
    sectionControl: 'Control room',
    sectionCrew: 'Crew view',
    showCrewNotes: 'Crew cues',
    showCrewNotesDesc: 'Lighting and media notes under each segment in the rundown.',
    scrollActiveIntoView: 'Scroll to current segment',
    scrollActiveIntoViewDesc: 'Keep the live segment visible in the program list.',
  },
  schedule: {
